...
class Gyro(Sensor):
    wb.wb_gyro_get_values.restype = ctypes.POINTER(ctypes.c_double)
    wb.wb_gyro_get_lookup_table.restype = ctypes.POINTER(ctypes.c_double)

    def __init__(self, name: typing.Union[str, int], sampling_period: int = None):
        #self._enable = True
        self._enable = wb.wb_gyro_enable
    ...
    def lookup_table(self) -> typing.List[float]:
        size = wb.wb_gyro_get_lookup_table_size(self._tag)

...
class Compass(Sensor):
    wb.wb_compass_get_values.restype = ctypes.POINTER(ctypes.c_double)
    wb.wb_compass_get_lookup_table.restype = ctypes.POINTER(ctypes.c_double)

    def __init__(self, name: typing.Union[str, int], sampling_period: int = None):
        self._enable = wb.wb_compass_enable
